...
## Corpus Check
- 104 files · ~99,657 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 323 nodes · 420 edges · 40 communities detected
...
3. `Context File Index` - 9 edges
4. `eliminateAndBroadcast()` - 8 edges
5. `send()` - 7 edges
6. `envelope()` - 7 edges
7. `Production-Grade Node.js Backend Setup Guide` - 7 edges
8. `endGame()` - 6 edges
...
- `resolveIdentity()` --calls--> `verifyAccessToken()`  [INFERRED]
  backend\src\realtime\websocket.ts → backend\src\utils\jwt.ts
...
Cohesion: 0.1
Nodes (30): broadcast(), send(), advanceTurn(), broadcastGameState(), computeAuthDeltas(), eliminateAndBroadcast(), endGame(), getRoomForPlayer() (+22 more)

### Community 1 - "Community 1"
Cohesion: 0.09
Nodes (10): ApiError, getBearerToken(), requireAuth(), buildAuthResult(), throwInvalidCredentials(), isAuthTokenPayload(), signAccessToken(), verifyAccessToken() (+2 more)
...
- **Thin community `Community 11`** (5 nodes): `capacityFor()`, `cellKey()`, `diffBoards()`, `tallyOrbs()`, `board.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 28`** (2 nodes): `Planned db/ Directory Layout`, `Repository Interface (matchesRepo etc)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 29`** (2 nodes): `Centralized Constants (LIMITS, MESSAGE_TYPES, ERROR_CODES)`, `Error Codes Table`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 30`** (2 nodes): `Critical Mass Rule`, `Critical Mass term`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 31`** (2 nodes): `Ownership Transfer on Explosion`, `Explosion term`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (1 nodes): `graphify query/path/explain CLI`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (1 nodes): `Frontend Responsibilities`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (1 nodes): `Non-goals for M1-M7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (1 nodes): `Backend Reading Order`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (1 nodes): `Project Directory Map`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 57`** (1 nodes): `File Naming Conventions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (1 nodes): `async/await Style`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (1 nodes): `Migrations (forward-only SQL files)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (1 nodes): `Frontend Common Gotchas`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (1 nodes): `Move Rule (click empty/own cell)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (1 nodes): `Win Condition (one survivor)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 63`** (1 nodes): `createBoard() function`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 64`** (1 nodes): `Cell term`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (1 nodes): `Board term`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (1 nodes): `Orb term`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (1 nodes): `Owner term`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (1 nodes): `Cascade / Chain Reaction term`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (1 nodes): `Player Index vs Player ID`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (1 nodes): `Bucket / Queue Key`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (1 nodes): `Frame / Broadcast / Send`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (1 nodes): `Words We Don't Use (match/lobby/session/game)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (1 nodes): `leave_queue message`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (1 nodes): `Rule: Conventional Commits`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `applyMove() function` connect `Community 5` to `Community 4`?**
...
- **Are the 5 inferred relationships involving `send()` (e.g. with `dispatch()` and `sendGameStateToPlayer()`) actually correct?**
