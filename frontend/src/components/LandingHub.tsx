...
import { KeyRound, Play, Plus, Sparkles, Trophy } from "lucide-react";
      ...
      <div className="relative mx-auto grid w-full max-w-[860px] place-items-center gap-8 pt-2 pb-12 sm:gap-10 [animation:panel-rise_0.6s_cubic-bezier(0.2,0.8,0.4,1)_both]">
        ...
        <div className="grid gap-3 text-center">
          ...
          >
            ...
            <span className="block bg-gradient-to-b from-uranium via-reactor to-plasma bg-clip-text text-transparent" style={{ WebkitTextStroke: "0.5px rgba(255,255,255,0.08)" }}>
              REACTION
            </span>
          </h1>
        ...
        <div className="grid w-full max-w-[460px] grid-cols-2 gap-3 sm:gap-4">
          <button
            type="button"
            onClick={handleOpenCreate}
            className="game-btn-shadow group relative flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-b from-cherenkov to-[#1ba0c4] px-5 py-4 font-display text-lg text-white game-text-shadow sm:text-xl [animation:button-bounce-in_0.5s_cubic-bezier(0.2,0.8,0.4,1)_0.25s_both]"
          >
          ...
          <button
            ...
            className="game-btn-shadow group relative flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-b from-radium to-[#7fb821] px-5 py-4 font-display text-lg text-bg-deep sm:text-xl [animation:button-bounce-in_0.5s_cubic-bezier(0.2,0.8,0.4,1)_0.35s_both]"
            style={{ textShadow: "0 2px 0 rgba(255,255,255,0.3)" }}
          >
            <KeyRound size={20} strokeWidth={3} aria-hidden="true" />
            <span>JOIN</span>
          </button>
        </div>
