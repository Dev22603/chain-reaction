    ...
    <header className="mx-auto flex w-full max-w-[1280px] items-center justify-between gap-3 px-4 py-5 sm:px-8 sm:py-6 lg:px-10">
      <Link href="/" className="flex min-w-0 items-center gap-2.5 transition-opacity hover:opacity-90">
        <span className="relative grid h-9 w-9 place-items-center">
          <span className="absolute inset-0 animate-[orb-pulse_2.4s_ease-in-out_infinite] rounded-full bg-cherenkov opacity-90" />
      ...
      <nav className="flex items-center gap-2">
        <Link
          href="/leaderboard"
          className="inline-flex min-h-10 shrink-0 items-center gap-2 rounded-full border-2 border-line bg-surface px-3 font-body text-sm font-semibold text-fg-soft transition-colors hover:border-cherenkov hover:text-cherenkov"
        >
        ...
        {loading ? (
          ...
          <>
            <Link
              ...
              className="inline-flex min-h-10 shrink-0 items-center gap-2 rounded-full border-2 border-cherenkov/50 bg-surface px-3 font-body text-sm font-semibold text-cherenkov transition-colors hover:bg-cherenkov/10"
            >
          ...
          <Link
            href="/login"
            className="inline-flex min-h-10 shrink-0 items-center gap-2 rounded-full border-2 border-reactor/50 bg-surface px-3.5 font-body text-sm font-semibold text-reactor transition-colors hover:border-reactor hover:bg-reactor/10"
          >
