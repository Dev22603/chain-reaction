...
// ⚡ Bolt: Optimized to avoid intermediate array allocations and .filter in hot loops
...
// ⚡ Bolt: Optimized to use O(1) mathematical boundary checks instead of array length
