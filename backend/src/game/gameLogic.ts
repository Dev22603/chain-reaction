...
// ⚡ Bolt: Removed array allocation and higher-order functions from getNeighbors
// in favor of direct mutation for better performance in hot loops.
...
// ⚡ Bolt: Computed critical mass mathematically instead of allocating
// an array of neighbors just to check its length, significantly reducing GC overhead.
