...
// ⚡ Bolt Optimization: Removed intermediate array allocations and .filter in hot path.
// getNeighbors uses direct .push() checks instead.
...
// ⚡ Bolt Optimization: Calculated mathematically instead of allocating arrays via getNeighbors
