...
// ⚡ Bolt: Avoid intermediate array allocations and filter to reduce GC pressure
...
// ⚡ Bolt: Use an additive approach from 0 to calculate critical mass without array allocations
